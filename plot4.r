...
par(mfrow=c(2,2))
plot(timedata, seldata$Global_active_power,type="l", ylab="Global Active Power", xlab="")
plot(timedata, seldata$Voltage,type="l", ylab="Voltage", xlab="datetime")
...
plot(timedata, seldata$Global_reactive_power,type="l", ylab="Global_reactive_power", xlab="datetime")
